	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: '++resource++collective.salesforce.fundraising/jquery.progressbar/images/progressbg_green.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '++resource++collective.salesforce.fundraising/jquery.progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'++resource++collective.salesforce.fundraising/jquery.progressbar/images/progressbg_red.gif',
									30: '++resource++collective.salesforce.fundraising/jquery.progressbar/images/progressbg_orange.gif',
									70: '++resource++collective.salesforce.fundraising/jquery.progressbar/images/progressbg_green.gif'
								},
